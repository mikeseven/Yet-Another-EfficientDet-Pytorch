...
ap.add_argument(
    "--nms_threshold", type=float, default=0.5, help="nms threshold, don't change it if not for testing purposes"
)
...
def evaluate_coco(img_path, set_name, image_ids, coco, model, threshold=0.05):
    ...
    with torch.inference_mode():
        for image_id in tqdm(image_ids):
            ...
            preds = postprocess(
                x, anchors, regression, classification, regressBoxes, clipBoxes, threshold, nms_threshold
            )
