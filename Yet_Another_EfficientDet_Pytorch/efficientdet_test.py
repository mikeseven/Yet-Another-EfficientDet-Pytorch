...
input_size = EfficientDetBackbone.input_sizes[compound_coef] if force_input_size is None else force_input_size
...
model = EfficientDetBackbone(
    compound_coef=compound_coef, num_classes=len(obj_list), ratios=anchor_ratios, scales=anchor_scales
)
