...
from Yet_Another_EfficientDet_Pytorch.utils.sync_batchnorm import SynchronizedBatchNorm2d
...
def get_last_weights(weights_path):
    ...
    weights_path = sorted(weights_path, key=lambda x: int(x.rsplit("_")[-1].rsplit(".")[0]), reverse=True)[0]
